...
class Account:
    ...
    def get_account_by_id(cls, data):
        ...
        accounts_from_db = connectToMySQL('pypie').query_db(query, data)
        accounts = []
    ...
    def get_account_exclude_id(cls, data):
        ...
        account_list = connectToMySQL('pypie').query_db(query, data)
        accounts = []
    ...
    def get_account_by_email(cls, data):
        ...
        account = connectToMySQL('pypie').query_db(query, data)
        #accounts = []
        #for a in account:
            #accounts.append(cls(a))
        return account
    ...
    def insert_one(cls, data):
        ...
        new_account_id = connectToMySQL('pypie').query_db(query, data)
